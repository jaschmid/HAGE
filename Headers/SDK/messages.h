...
enum {
	// Resource MESSAGE 0012 0000
	MESSAGE_RESOURCE_UNKNOWN			= 0x00120000,
	MESSAGE_RESOURCE_REQUEST_LOAD		= 0x80120001,
	MESSAGE_RESOURCE_NOTIFY_LOADED		= 0x80120002,
	MESSAGE_RESOURCE_NOTIFY_STREAM_OPEN	= 0x80120003,
	MESSAGE_RESOURCE_NOTIFY_STREAM_IN	= 0x80120004,
	MESSAGE_RESOURCE_NOTIFY_STREAM_OUT	= 0x80120005,
	MESSAGE_RESOURCE_REQUEST_STREAM_CLOSE= 0x80120006,
};
