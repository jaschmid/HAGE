...
extern void _jxr_rbitstream_initialize(struct rbitstream*str, const unsigned char* buffer, unsigned int buffer_size);
...
extern void _jxr_wbitstream_initialize(struct wbitstream*str, unsigned char* buffer, unsigned int buffer_size);
