...
* bitstream.
*/
JXR_EXTERN int jxr_read_image_bitstream(jxr_image_t image, const unsigned char* buffer, unsigned int buffer_size);
...
*/
JXR_EXTERN int jxr_write_image_bitstream(jxr_image_t image, unsigned char* buffer, unsigned int buffer_size);
